...
public class ProductTest {
	...
	public static void beforeAll(){
		...
		p2spec = Arrays.asList("8gb ram","4tb hdd","pentium i5");
		p3spec = Arrays.asList("2gb ram","14mp","64gb storage");
		p4spec = Arrays.asList("4gb ram","16mp","120gb storage");
	...
	public void testProduct7() throws NotFoundException{
		when(dao.getCatNProds()).thenReturn(catMap);
		assertThrows(NotFoundException.class, ()->ser.getProductInfo("aaa", 1003));
	}
